...
-Good introduction with some discussion of the topic and the aim of the project
...
-Good note made concerning data recommendations so it runs more smoothly and good use of pipes 
# Results
...
-Good code but maybe include a little on why those parameters were chosen for the graph 
